<template>
	<div>
	 	<div class="my_title title_bg" >
            <!-- <div class="head">
                <img src="../../../../images_new/default_head_2.png"/>
            </div> -->
        </div>
        <div v-show="isBind">
        	<ul>
	...
	export default{
		...
		data(){
			return {
					...
					menu:[
						{
							"img":`${this.HOST}/images_new/icon_my_setting.png`,
							"name":"设置",
							"height":7,
							"sub_menu":[
								{
						...
						{
							"img":`${this.HOST}/images_new/icon_my_collection.png`,
							"name":"本地内容",
							"tag":"local_list",
							"height":7,
							"sub_menu":[
						...
						{
							"img":`${this.HOST}/images_new/foot_print.png`,
							"name":"点滴记忆",
							"path":"/footprint",
							"sub_menu":[
		...
		methods:{
			...
			goAirkiss:function(){
				...
				window.location.href = `https://www.cocheer.net/qmh_test/airkiss?openid=${openid}`
			},
			getVersion:function(){
				const This = this
...
<style scoped>
	...
	.arrow{
		...
		right:2rem;
		background: url(../../../../images_new/icon_have_more.png) no-repeat  center;
		background-size:40%;
	...
	.title_bg{
		background:url(../../../../images_new/robot_bg.png);
		background-size: 100%;
	}
