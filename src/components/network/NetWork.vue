    ...
    <div class="main wx_main">
        ...
        <template v-if="$route.params.subname === 'ap2'">
            <div class="shake-horizontal" :class="{run: run}" @click="select('ap3')">
                ...
                <span class="wxc">手机已连接到<span class="em_font">“qmh-XXXX”</span></span>
            </div>
        </template>
        <!-- <template v-if="$route.params.subname === 'ap2'">
            <div class="shake-horizontal" @click="showApTip()">
                    ...
                    .catch((error) => {
                        ...
                        if(this.next_url){
                            if(this.next_count > 3){
                                //this.pop_title = "温馨提示";
                                //this.pop_content = "<div style='text-align: center;padding:0 20px'>" + "请确认眼灯是否闪烁，进入qmh热点联网模式" + "</div>";
                                //this.pop_component = Pop;
                            }else{
                                this.$toast('请将手机Wi-Fi连接到qmh-xxxx');
                            }
                        }else{
                           // this.showTips()
                            //this.pop_component = Pop
