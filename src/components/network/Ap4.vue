...
export default {
	...
	methods: {
		...
		showSuccess() {
			...
			setTimeout(function(){
				window.location.href = `https://www.cocheer.net/happy/page/dist/#/index?openid=${openid}`
			},1500)
			//},1500);
		},
		showFailed() {
...
<style scoped>
	...
	.circle:after{
	    ...
	    content: '';
	    display: block;
	    background: url(../../../../images_new/icon_ota_warning.png) center center no-repeat;
	    background-size: 100%;
	    left: 50%;
	...
	.upfailed:after {
	    background-image: url(../../../../images_new/icon_ota_fail.png);
	    width: 4rem;
	    height: 6rem;
	    top: -8rem;
	    animation: none;
	...
	.upsuccess:after {
	    background-image: url(../../../../images_new/icon_ota_success.png);
	    height: 6rem;
	    top: -8rem;
	    width: 4rem;
	    animation: none;
